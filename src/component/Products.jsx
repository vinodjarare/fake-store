...
import { Link  } from 'react-router-dom';
 const Products = () => {
     ...
     const ShowProducts =() => {
         return(
         <>
         <div className="buttons justify-content-center my-4 text-center">
            ...
            {filter.map((product)=> {
                return (
                    <>
                        <div className="col-md-3 my-2 bg-white">
                        <div className="card h-100 text-center p-3" key={product.id}>
                        <img src={product.image} className="card-img-top" alt={product.title} height="290px"/>
