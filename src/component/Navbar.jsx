...
export default function Navbar() {
  ...
  <div className="container">
    <NavLink className="navbar-brand fw-bold fs-4" to="/">Fashion Store</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="buttons">
            ...
            <NavLink to="/signin" className="btn btn-outline-dark ms-2"><i className="fa fa-user-plus me-1"></i>Register</NavLink>
